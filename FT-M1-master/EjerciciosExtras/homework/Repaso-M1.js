...
BinarySearchTree.prototype.sum = function () {
    const suma = this.value;
    const arrayflotante = [];
    
    if (this.left === null && this.right === null) {
      return arrayflotante.push(this.value);
    }
    if (this.left === null) {
      return arrayflotante.push(this.value) + this.right.sum();
    }
    if (this.right === null) {
      return arrayflotante.push(this.value) + this.left.sum();
    }
  }
    return arrayflotante.push(this.value) + this.left.sum() + this.right.sum();
